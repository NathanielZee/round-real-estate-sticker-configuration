...
export default function StickerCalculator() {
  ...
  // Map color combinations to their respective image files
  const getPreviewImage = () => {
    switch (selectedColorCombination) {
      case "white-blue":
        return "/Round_Whitebg_Blue-Text.png"
      case "black-white":
        return "/Round_Black-BG_white_text.png"
      case "white-red":
        return "/Round_WhiteBG_Red-Text.png"
      case "red-white":
        return "/Round_Redbg_Whitetext.png"
      case "blue-white":
        return "/Round_Blue-BG_white_text.png"
      case "white-black":
        return "/Round_Whitebg_Blk-Text.png"
      default:
        return null
    }
  }
      ...
      <div className="w-full max-w-xs sm:max-w-md lg:max-w-xl xl:max-w-2xl bg-white rounded-lg p-3 sm:p-6 lg:p-8 shadow-sm border border-gray-200">
        <form className="space-y-3 sm:space-y-6">
          ...
          {selectedSize !== null &&
            ...
            (() => {
              const useCustomImage = selectedText === "SOLD"
                  ...
                  <div className="border border-gray-300 rounded-lg p-4 bg-gray-50 flex justify-center">
                    {useCustomImage && previewImage ? (
                      <img
                        ...
                        alt={`SOLD sticker preview - ${selectedColorCombination}`}
          ...
          <div>
            <label htmlFor="artwork-method" className="text-gray-700 font-medium text-xs sm:text-sm block mb-3">
